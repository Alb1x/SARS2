...
class Lift:
    ...
    def Aller4(self,_dir='n'):
        if 4 not in self.target :
            ...
            elif 4<max(self.CurEtage, self.target[0]) and 4>min(self.CurEtage, self.target[0]): # Si sur le chemin
    ...
    def Aller3(self,_dir='n'):
        if 3 not in self.target :
            ...
            elif 3<max(self.CurEtage, self.target[0]) and 3>min(self.CurEtage, self.target[0]): # Si sur le chemin
                if _dir==self.curMouvement or _dir=='n': #dans la même direction
    ...
    def Aller2(self,_dir='n'):
        if 2 not in self.target :
            ...
            elif (2<max(self.CurEtage, self.target[0])) and (2>min(self.CurEtage, self.target[0])): # Si sur le chemin
                if _dir==self.curMouvement or _dir=='n': #dans la même direction
...
class Etages(Lift):
    def __init__(self, master,Lift):
        ...
        self.button5u.pack()
        '''
        self.button5d=tk.Button(self.frame,text='5 v',command=Lift.Aller5d)
        self.button5d.pack()

        self.button4u=tk.Button(self.frame,text='4 ^',command=Lift.Aller4u)
        self.button4u.pack()
        self.button4d=tk.Button(self.frame,text='4 v',command=Lift.Aller4d)
        self.button4d.pack()

        self.button3u=tk.Button(self.frame,text='3 ^',command=Lift.Aller3u)
        self.button3u.pack()
        self.button3d=tk.Button(self.frame,text='3 v',command=Lift.Aller3d)
        self.button3d.pack()

        self.button2u=tk.Button(self.frame,text='2 ^',command=Lift.Aller2u)
        self.button2u.pack()
        self.button2d=tk.Button(self.frame,text='2 v',command=Lift.Aller2d)
        self.button2d.pack()

        self.button1u=tk.Button(self.frame,text='1 ^',command=Lift.Aller1u)
        self.button1u.pack()
        '''
