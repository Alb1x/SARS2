...
class Lift_bug2:
    def __init__(self, master):
        ...
        self.master.title("Ascenseur")
        self.master.geometry("360x280+500+200")
        self.description="le bouton <<>> retire du temps au chrono (les portes restent ouvertes plus longtemps)"
...
class Lift_bug3:
    def __init__(self, master):
        ...
        self.master.title("Ascenseur")
        self.master.geometry("360x280+500+200")
        self.description="Ascenseur qui échange 2 boutons à l'extérieur de l'ascenseur."
    ...
    def Aller5d(self):
        ...
        if etages_bug[0]==5 or etages_bug[1]==5 :
            if etages_bug[0]==5 :
                ...
                Aller=getattr(Lift_bug3, "Aller"+str(etages_bug[1]))
            else :
                #self.__dict__["Aller"+str(self.etages_bug[0])](_dir='-')
                Aller=getattr(Lift_bug3, "Aller"+str(etages_bug[0]))
            Aller(self,_dir='-')
        else :
            self.Aller5(_dir='-')
...
class Lift_bug4:
    def __init__(self, master):
        ...
        self.master.title("Ascenseur")
        self.master.geometry("360x280+500+200")
        self.description="Ascenseur dont le bouton choisi ne marche plus au bout d'un temps donné."
...
def main(): 
    root = tk.Tk()
    L=[Lift,Lift_bug1,Lift_bug2,Lift_bug3,Lift_bug4]
    if(len(sys.argv) ==1):
        app=L[0](root)
    else :
        arg=sys.argv[1]
